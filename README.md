...
##1. Motivarea și scopul proiectului:
  Motivarea
...
/Generator-de-parole-securizare/
│
├── main.py                 # Interfața principală CLI
├── generator.py            # Generarea parolelor
├── analyzer.py             # Analiza puterii parolelor
├── storage.py              # Stocarea istoricului securizat
├── common_password.txt     # Top 1000 parole comune
├── history.json            # Istoric parole (generat automat)
└── Dockerfile              # Containerizare aplicație
...
##5.Explicația funcților: 
   a. Generarea parolelor (generator.py)
...
Oferă un compromis între securitate și memorabilitate.
   ...
   b. Analizarea securității parolelor(analyzer.py)
->analyzer_password()
...
Transforma valoarea entropiei într-o clasificare ușor de înteles.
   ...
   c.Stocarea informaților (storage.py)
->hash_password()
...
##Exemplu de output:
a. python main.py --length 16 --upper --digits --special
Parola generata: k0T^v>O?4)Uwcl!e
Putere: FOARTE PUTERNICA
Entropie: 104.87
Salvata in istoric

b. python main.py --check parola12
...
c. python main.py --memorable --words 3
